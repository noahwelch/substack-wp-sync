...
6. **Media Handling:** Sideloads each image once via `media_sideload_image()` (deduped by source URL), rewrites content to serve the local copies, and sets the first as the featured image
